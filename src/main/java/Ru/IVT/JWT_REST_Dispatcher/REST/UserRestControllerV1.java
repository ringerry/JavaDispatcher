    ...
    documentation() throws Exception {
        ...
        try{
            ...
            msg="Приложение на Python должно содержать точку входа - файл 'Main.py'; приложение на TypeScript " +
                    ...
                    "и консольный вывод. Если в программе есть ошибки, пользователь может запросить выходную папку, " +
                    "в которой содержится консольный вывод с сообщениями транслятора." +
